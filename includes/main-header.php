...
>>>>>>> parent of 131e4d0 (update header.css)
            ...
            <ul class="main-nav nav col-8 justify-content-around align-items-center">
                ...
                <li class="main-nav-item nav-item"><a href="index.php"><img src="assets/images/website/logo/logo.png" alt="Minisize Logo" width="75"></a></li>
