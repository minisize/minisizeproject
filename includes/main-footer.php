<footer>
    <div class="footer-wrap side-footer ">
        ...
        <div class="Footer-Sub-Wrap">
            ...
            <label for="">
                <button class="border-0 bg-light px-2 mx-1"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-hand-thumbs-up-fill" viewBox="0 0 16 16">
    ...
    <div class="footer-wrap side-footer">
        ...
        <h6 class="fw-light"> MiniSize@Gmail.com </h6>
    </div>
</footer>
